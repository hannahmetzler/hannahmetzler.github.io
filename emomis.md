...
* Our first two papers got published in December and January! They are about the role of [emotions in misinformation](https://rdcu.be/d36bX) and best-practices for measuring [news trustworthiness using the NewsGuard database](https://journalqd.org/article/view/4500). Here's a Bluesky [thread](https://twitter.com/hannahmetzler1/status/1643978293455241217) summarizing the emotions paper. 
